...
export function ExpositoreSection({
    ...
    const accessoryMapping = [{
        field: 'ripiano30x30' as keyof ExpositoreData,
        name: 'Ripiano 30x30'
    }, {
        field: 'ripiano50x50' as keyof ExpositoreData,
        name: 'Ripiano 50x50'
    }, {
        field: 'ripiano100x50' as keyof ExpositoreData,
        name: 'Ripiano 100x50'
    }, {
        field: 'tecaPlexiglass30x30x30' as keyof ExpositoreData,
        name: 'Teca in plexiglass 30x30x30'
    }, {
        field: 'tecaPlexiglass50x50x50' as keyof ExpositoreData,
        name: 'Teca in plexiglass 50x50x50'
    }, {
        field: 'tecaPlexiglass100x50x30' as keyof ExpositoreData,
        name: 'Teca in plexiglass 100x50x30'
    }, {
        field: 'retroilluminazione30x30x100h' as keyof ExpositoreData,
        name: 'Retroilluminazione 30x30x100 H'
    }, {
        field: 'retroilluminazione50x50x100h' as keyof ExpositoreData,
        name: 'Retroilluminazione 50x50x100 H'
    }, {
        field: 'retroilluminazione100x50x100h' as keyof ExpositoreData,
        name: 'Retroilluminazione 100x50x100 H'
    }, {
        field: 'borsaEspositori' as keyof ExpositoreData,
        name: 'Borsa'
    }];
                    ...
                    <div className="grid grid-cols-4 gap-4">
                        ...
                        <div className="space-y-1">
                            <Input type="number" min="0"
                                   value={formData.qtaTipo30 === 0 ? '' : formData.qtaTipo30.toString()}
                                   onChange={e => handleInputChange('qtaTipo30', e.target.value)} placeholder="0"/>
                        </div>

                        <div className="space-y-1">
                            <Input type="number" min="0"
                                   value={formData.qtaTipo50 === 0 ? '' : formData.qtaTipo50.toString()}
                                   onChange={e => handleInputChange('qtaTipo50', e.target.value)} placeholder="0"/>
                        </div>

                        <div className="space-y-1">
                            <Input type="number" min="0"
                                   value={formData.qtaTipo100 === 0 ? '' : formData.qtaTipo100.toString()}
                                   onChange={e => handleInputChange('qtaTipo100', e.target.value)} placeholder="0"/>
                        </div>
                    </div>
                </div>
            </CardContent>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="flex items-center gap-1">
                                    <Input type="number" min="0" max="200" step="1"
                                           ...
                                           onChange={e => onChange('marginalitaStrutturaEspositori', e.target.value === '' ? 0 : Number(e.target.value))}
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="flex items-center gap-1">
                                    <Input type="number" min="0" max="200" step="1"
                                           ...
                                           onChange={e => onChange('marginalitaGraficaEspositori', e.target.value === '' ? 0 : Number(e.target.value))}
                                           className="w-16 h-6 text-xs text-center"/>
                                    <span className="text-xs">%</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="flex items-center gap-1">
                                    <Input type="number" min="0" max="200" step="1"
                                           ...
                                           onChange={e => onChange('marginalitaPremontaggioEspositori', e.target.value === '' ? 0 : Number(e.target.value))}
                                           className="w-16 h-6 text-xs text-center"/>
                                    <span className="text-xs">%</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <div className="flex items-center gap-1">
                                    <Input type="number" min="0" max="200" step="1"
                                           ...
                                           onChange={e => onChange('marginalitaAccessoriEspositori', e.target.value === '' ? 0 : Number(e.target.value))}
                                           className="w-16 h-6 text-xs text-center"/>
                                    <span className="text-xs">%</span>
                                </div>
                            </div>
