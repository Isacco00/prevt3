...
interface StandSectionProps {
    formData: {
        ...
        accessoriStand: Record<string, number>;
    };
    ...
    costs: {
        ...
        // Preventivo values
        preventivoStruttura: number;
        preventivoGrafica: number;
        preventivoRetroilluminazione: number;
        preventivoAccessori: number;
        preventivoPremontaggio: number;
        // Summary values
        totalePreventivoStand: number;
        totaleCostiStand: number;
        marginalitaMedia: number;
        totale: number;
    };
}
        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                    ...
                    <Input id="profondita" type="number" step="0.5" min="0" max="15" value={formData.profondita}
                ...
                <div className="space-y-2">
                    ...
                    <Input id="larghezza" type="number" step="0.5" min="0" max="15" value={formData.larghezza}
                           onChange={e => setFormData({
                               ...formData,
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                    ...
                    <Input id="bifaccialita" type="number" step="0.5" min="0" max="15" value={formData.bifaccialita}
                           onChange={e => setFormData({
                               ...formData,
                ...
                <div className="space-y-2">
                    ...
                    <Input id="retroilluminazione" type="number" step="0.5" min="0" max="15"
                           value={formData.retroilluminazione} onChange={e => setFormData({
                        ...formData,
        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{physicalElements.superficieStampa.toFixed(2)}</div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">{physicalElements.sviluppoLineare.toFixed(2)}</div>
                        <p className="text-xs text-muted-foreground">m</p>
                    </CardContent>
                </Card>
                                    ...
                                    {accessoriStand.map(accessorio => {
                                        ...
                                        return <TableRow key={accessorio.id}>
                                            ...
                                            <TableCell className="text-center py-1">
                                                € {accessorio.costoUnitario.toString().replace('.', ',')}
                                            </TableCell>
                                            <TableCell className="text-center">
                                                <Input type="number" min="0" max="99" value={quantity}
        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Card className="p-4">
                    ...
                    <div className="flex justify-between items-end">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-1">
                                <Input type="number" min="0" max="200" step="1"
                                       value={formData.marginalitaStruttura || 0} onChange={e => setFormData({
                                    ...formData,
                        ...
                        <div className="text-lg font-bold text-primary">€{costs.preventivoStruttura.toFixed(2)}</div>
                    </div>
                </Card>
                ...
                <Card className="p-4">
                    ...
                    <div className="flex justify-between items-end">
                        ...
                        <div className="text-lg font-bold text-primary">€{costs.preventivoGrafica.toFixed(2)}</div>
                    </div>
                </Card>
                ...
                <Card className="p-4">
                    ...
                    <div className="flex justify-between items-end">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-1">
                                <Input type="number" min="0" max="200" step="1"
                                       value={formData.marginalitaRetroilluminazione || 0} onChange={e => setFormData({
                                    ...formData,
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Card className="p-4">
                    ...
                    <div className="flex justify-between items-end">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-1">
                                <Input type="number" min="0" max="200" step="1"
                                       value={formData.marginalitaAccessori || 0} onChange={e => setFormData({
                                    ...formData,
                        ...
                        <div className="text-lg font-bold text-primary">€{costs.preventivoAccessori.toFixed(2)}</div>
                    </div>
                </Card>
                ...
                <Card className="p-4">
                    ...
                    <div className="flex justify-between items-end">
                        <div className="flex flex-col gap-1">
                            ...
                            <div className="flex items-center gap-1">
                                <Input type="number" min="0" max="200" step="1"
                                       value={formData.marginalitaPremontaggio || 0} onChange={e => setFormData({
                                    ...formData,
                ...
                <Card className="p-4">
                    ...
                    <div className="flex justify-between items-end">
                        <div className="flex flex-col gap-1">
                            <div className="text-xs text-muted-foreground my-[4px] py-px">Extra % su Costo Struttura
                            </div>
                            <div className="flex items-center gap-1">
                                <Input type="number" min="0" max="200" step="1" value={formData.extraPercComplex || 0}
                                       onChange={e => setFormData({
                                           ...formData,
                        ...
                        <div className="text-lg font-bold text-primary">€{costs.extraStandComplesso.toFixed(2)}</div>
                    </div>
