...
export default function Admin() {
  ...
  const [editingParameter, setEditingParameter] = useState<ParametriBean | null>(null);
  const [editValue, setEditValue] = useState<ParametriBean['valore'] | null>(null);
  ...
  const addRetroMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile aggiungere la riga.',
        variant: 'destructive'
      });
    },
  });
  ...
  const addAccessorioMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile aggiungere accessorio.',
        variant: 'destructive'
      });
    },
  });
  ...
  const updateAccessorioMutation = useMutation({
    mutationFn: async ({id, nome, costo_unitario}: {
      id: string;
      nome: string;
    ...
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile aggiornare accessorio.',
        variant: 'destructive'
      });
    },
  });
  ...
  const deleteAccessorioMutation = useMutation({
    ...
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile eliminare accessorio.',
        variant: 'destructive'
      });
    },
  });
  ...
  const addAccessorioDeskMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: 'Accessorio Desk aggiunto',
        description: 'Accessorio Desk aggiunto con successo.'
      });
    ...
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile aggiungere accessorio Desk.',
        variant: 'destructive'
      });
    },
  });
  ...
  const updateAccessorioDeskMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({queryKey: ['listino-accessori-desk']});
      toast({
        title: 'Accessorio Desk aggiornato',
        description: 'Accessorio Desk aggiornato con successo.'
      });
    ...
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile aggiornare accessorio Desk.',
        variant: 'destructive'
      });
    },
  });
  ...
  const deleteAccessorioDeskMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({queryKey: ['listino-accessori-desk']});
      toast({
        title: 'Accessorio Desk eliminato',
        description: 'Accessorio Desk eliminato con successo.'
      });
    },
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile eliminare accessorio Desk.',
        variant: 'destructive'
      });
    },
  });
  ...
  const addCostoStrutturaDeskMutation = useMutation({
    mutationFn: async ({layout_desk, costo_unitario}: {
      layout_desk: string;
      costo_unitario: number
    }) => {
      const {error} = await supabase
    ...
    onSuccess: () => {
      ...
      toast({
        title: 'Costo struttura Desk aggiunto',
        description: 'Costo struttura Desk aggiunto con successo.'
      });
    ...
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile aggiungere costo struttura Desk.',
        variant: 'destructive'
      });
    },
  });
  ...
  const updateCostoStrutturaDeskMutation = useMutation({
    mutationFn: async ({id, layout_desk, costo_unitario}: {
      id: string;
      layout_desk: string;
      costo_unitario: number
    }) => {
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({queryKey: ['costi-struttura-desk-layout']});
      toast({
        title: 'Costo struttura Desk aggiornato',
        description: 'Costo struttura Desk aggiornato con successo.'
      });
    ...
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile aggiornare costo struttura Desk.',
        variant: 'destructive'
      });
    },
  });
  ...
  const deleteCostoStrutturaDeskMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({queryKey: ['costi-struttura-desk-layout']});
      toast({
        title: 'Costo struttura Desk eliminato',
        description: 'Costo struttura Desk eliminato con successo.'
      });
    },
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile eliminare costo struttura Desk.',
        variant: 'destructive'
      });
    },
  });
  ...
  const addCostoStrutturaEspositoreMutation = useMutation({
    mutationFn: async ({layout_espositore, costo_unitario}: {
    ...
    onSuccess: () => {
      ...
      toast({
        title: 'Costo struttura Espositore aggiunto',
        description: 'Costo struttura Espositore aggiunto con successo.'
      });
    ...
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile aggiungere costo struttura Espositore.',
        variant: 'destructive'
      });
    },
  });
  ...
  const updateCostoStrutturaEspositoreMutation = useMutation({
    mutationFn: async ({id, layout_espositore, costo_unitario}: {
      id: string;
      layout_espositore: string;
      costo_unitario: number
    }) => {
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({queryKey: ['costi-struttura-espositori-layout']});
      toast({
        title: 'Costo struttura Espositore aggiornato',
        description: 'Costo struttura Espositore aggiornato con successo.'
      });
    ...
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile aggiornare costo struttura Espositore.',
        variant: 'destructive'
      });
    },
  });
  ...
  const deleteCostoStrutturaEspositoreMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({queryKey: ['costi-struttura-espositori-layout']});
      toast({
        title: 'Costo struttura Espositore eliminato',
        description: 'Costo struttura Espositore eliminato con successo.'
      });
    },
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile eliminare costo struttura Espositore.',
        variant: 'destructive'
      });
    },
  });
  ...
  const handleAddRetroSave = () => {
    ...
    if (isNaN(hVal) || isNaN(cVal)) {
      toast({
        title: 'Errore',
        description: 'Inserisci valori validi (usa la virgola per i decimali).',
        variant: 'destructive'
      });
      return;
    }
  ...
  const handleAccessorioSave = () => {
    ...
    if (isNaN(cVal)) {
      toast({
        title: 'Errore',
        description: 'Inserisci un costo valido (usa la virgola per i decimali).',
        variant: 'destructive'
      });
      return;
    }
  ...
  const handleAddAccessorioSave = () => {
    ...
    if (isNaN(cVal) || !newAccessorioNome.trim()) {
      toast({
        title: 'Errore',
        description: 'Inserisci nome e costo validi (usa la virgola per i decimali).',
        variant: 'destructive'
      });
      return;
    }
  ...
  const handleAddAccessorioDeskSave = () => {
    ...
    if (isNaN(cVal) || !newAccessorioDeskNome.trim()) {
      toast({
        title: 'Errore',
        description: 'Inserisci nome e costo validi.',
        variant: 'destructive'
      });
      return;
    }
  ...
  const handleAddCostoStrutturaDeskSave = () => {
    ...
    if (isNaN(cVal) || !newLayoutDesk.trim()) {
      toast({
        title: 'Errore',
        description: 'Inserisci layout e costo validi.',
        variant: 'destructive'
      });
      return;
    }
  ...
  const handleAddCostoStrutturaEspositoreSave = () => {
    ...
    addCostoStrutturaEspositoreMutation.mutate({
      layout_espositore: newLayoutEspositore.trim(),
      costo_unitario: cVal
    });
  };
  ...
  const addAccessorioEspositoriMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: 'Accessorio Espositori aggiunto',
        description: 'Accessorio Espositori aggiunto con successo.'
      });
    ...
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile aggiungere accessorio Espositori.',
        variant: 'destructive'
      });
    },
  });
  ...
  const updateAccessorioEspositoriMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({queryKey: ['listino-accessori-espositori']});
      toast({
        title: 'Accessorio Espositori aggiornato',
        description: 'Accessorio Espositori aggiornato con successo.'
      });
    ...
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile aggiornare accessorio Espositori.',
        variant: 'destructive'
      });
    },
  });
  ...
  const deleteAccessorioEspositoriMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({queryKey: ['listino-accessori-espositori']});
      toast({
        title: 'Accessorio Espositori eliminato',
        description: 'Accessorio Espositori eliminato con successo.'
      });
    },
    onError: (error: any) => {
      toast({
        title: 'Errore',
        description: error?.message || 'Impossibile eliminare accessorio Espositori.',
        variant: 'destructive'
      });
    },
  });
  ...
  const handleAddAccessorioEspositoriSave = () => {
    ...
    addAccessorioEspositoriMutation.mutate({
      nome: newAccessorioEspositoriNome.trim(),
      costo_unitario: cVal
    });
  };
  ...
  const renderParameterRow = (parametro: ParametriBean, showDescription = false) => (
      <TableRow key={parametro.id}>
        <TableCell className="font-medium">
          {showDescription ? parametro.descrizione : parametro.nome}
        </TableCell>
        <TableCell>
          {editingParameter?.id === parametro.id ? (
              <div className="flex items-center gap-2">
                <Input
                    type="number"
                    step="0.01"
          ...
          <TabsContent value="parametri" className="space-y-6">
                                ...
                                <>
                                  <Button
                                      ...
                                      onClick={() => {
                                        ...
                                        if (!isNaN(value)) {
                                          updateParametriCostiUnitariMutation.mutate({
                                            id: parametro.id,
                                            valore: value
                                          });
                                          setEditingParameter(null);
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Numero di profili m/l in funzione della
                  distribuzione</CardDescription>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
              ...
              <CardHeader>
                <div className="flex flex-row items-center justify-between">
                  <div>
                    ...
                    <CardDescription>Costo retroilluminazione al metro lineare in funzione
                      dell'altezza</CardDescription>
                  </div>
              ...
              <CardContent>
                {showAddRetro && (
                    <div className="mb-4 flex items-end gap-2">
                      ...
                      <Button size="sm" onClick={handleAddRetroSave}
                              disabled={addRetroMutation.isPending}>
                        <Save className="h-4 w-4"/>
                      </Button>
              ...
              <CardContent>
                {showAddAccessorio && (
                    <div className="mb-4 flex items-end gap-2">
                      ...
                      <Button size="sm" onClick={handleAddAccessorioSave}
                              disabled={addAccessorioMutation.isPending}>
                        <Save className="h-4 w-4"/>
                      </Button>
                ...
                <Table>
                  ...
                  <TableBody>
                    {isLoadingAccessori ? (
                        ...
                        <TableRow>
                          <TableCell colSpan={3} className="text-center">Nessun accessorio
                            trovato</TableCell>
                        </TableRow>
                    ) : (
                              ...
                              <TableCell>
                                {editingAccessorioId === accessorio.id ? (
                                    <div className="flex items-center gap-1">
                                      <Button size="sm" onClick={handleAccessorioSave}
                                              disabled={updateAccessorioMutation.isPending}>
                                        <Save className="h-4 w-4"/>
                                      </Button>
                                      <Button size="sm" variant="outline"
                                              onClick={handleAccessorioCancel}>
                                        <X className="h-4 w-4"/>
                                      </Button>
                                    </div>
                                ) : (
                                    <div className="flex items-center gap-1">
                                      <Button size="sm" variant="outline"
                                              onClick={() => handleEditAccessorio(accessorio)}>
              ...
              <CardContent>
                {showAddAccessorioDesk && (
                    <div className="mb-4 flex items-end gap-2">
                      ...
                      <Button size="sm" onClick={handleAddAccessorioDeskSave}
                              disabled={addAccessorioDeskMutation.isPending}>
                        <Save className="h-4 w-4"/>
                      </Button>
                ...
                <Table>
                  ...
                  <TableBody>
                    {accessoriDesk && accessoriDesk.length > 0 ? (
                            ...
                            <TableRow key={accessorio.id}>
                              <TableCell>
                                {editingAccessorioDesk?.id === accessorio.id ? (
                                    <Input
                                        ...
                                        onChange={(e) => setEditingAccessorioDesk({
                                          ...editingAccessorioDesk,
                                          nome: e.target.value
                                        })}
                                        className="w-full"
                                    />
                                ...
                                {editingAccessorioDesk?.id === accessorio.id ? (
                                    <div className="flex items-center gap-2">
                                      ...
                                      <Input
                                          ...
                                          onChange={(e) => setEditingAccessorioDesk({
                                            ...editingAccessorioDesk,
                                            costo_unitario: parseFloat(e.target.value.replace(',', '.')) || 0
                                          })}
                                          className="w-24"
                                      />
                                    </div>
                              ...
                              <TableCell>
                                {editingAccessorioDesk?.id === accessorio.id ? (
                                    <div className="flex items-center gap-1">
                                      <Button size="sm"
                                              onClick={() => updateAccessorioDeskMutation.mutate(editingAccessorioDesk)}
                                              disabled={updateAccessorioDeskMutation.isPending}>
                                        <Save className="h-4 w-4"/>
                                      </Button>
                                      <Button size="sm" variant="outline"
                                              onClick={() => setEditingAccessorioDesk(null)}>
                                        <X className="h-4 w-4"/>
                                      </Button>
                                    </div>
                                ) : (
                                    <div className="flex items-center gap-1">
                                      <Button size="sm" variant="outline"
                                              onClick={() => setEditingAccessorioDesk(accessorio)}>
                                        <Edit className="h-4 w-4"/>
                                      </Button>
                                      <Button
                                          size="sm"
                        ...
                        <TableRow>
                          <TableCell colSpan={3} className="text-center">Nessun accessorio desk
                            trovato</TableCell>
                        </TableRow>
                    )}
                  </TableBody>
              ...
              <CardHeader>
                <div className="flex flex-row items-center justify-between">
                  <div>
                    ...
                    <CardDescription>Gestione accessori espositori con relativi
                      costi</CardDescription>
                  </div>
                  <div className="w-[120px] flex justify-end">
              ...
              <CardContent>
                {showAddAccessorioEspositori && (
                    <div className="mb-4 flex items-end gap-2">
                      ...
                      <Button size="sm" onClick={handleAddAccessorioEspositoriSave}
                              disabled={addAccessorioEspositoriMutation.isPending}>
                        <Save className="h-4 w-4"/>
                      </Button>
                      <Button size="sm" variant="outline"
                              onClick={handleAddAccessorioEspositoriCancel}>
                        <X className="h-4 w-4"/>
                      </Button>
                    </div>
                )}
                            ...
                            <TableRow key={accessorio.id}>
                              <TableCell>
                                {editingAccessorioEspositori?.id === accessorio.id ? (
                                    <Input
                                        ...
                                        onChange={(e) => setEditingAccessorioEspositori({
                                          ...editingAccessorioEspositori,
                                          nome: e.target.value
                                        })}
                                    />
                                ) : (
                              ...
                              <TableCell>
                                {editingAccessorioEspositori?.id === accessorio.id ? (
                                    <div className="flex items-center gap-1">
                                      <Button size="sm"
                                              onClick={() => updateAccessorioEspositoriMutation.mutate(editingAccessorioEspositori)}
                                              disabled={updateAccessorioEspositoriMutation.isPending}>
                                        <Save className="h-4 w-4"/>
                                      </Button>
                                      <Button size="sm" variant="outline"
                                              onClick={() => setEditingAccessorioEspositori(null)}>
                                        <X className="h-4 w-4"/>
                                      </Button>
                                    </div>
                                ) : (
                                    <div className="flex items-center gap-1">
                                      <Button size="sm" variant="outline"
                                              onClick={() => setEditingAccessorioEspositori(accessorio)}>
                                        <Edit className="h-4 w-4"/>
                                      </Button>
                                      <Button
                                          size="sm"
              ...
              <CardContent>
                {showAddCostoStrutturaDesk && (
                    <div className="mb-4 flex items-end gap-2">
                      ...
                      <Button size="sm" onClick={handleAddCostoStrutturaDeskSave}
                              disabled={addCostoStrutturaDeskMutation.isPending}>
                        <Save className="h-4 w-4"/>
                      </Button>
                      <Button size="sm" variant="outline"
                              onClick={handleAddCostoStrutturaDeskCancel}>
                        <X className="h-4 w-4"/>
                      </Button>
                    </div>
                )}
                <Table>
                  ...
                  <TableBody>
                    {costiStrutturaDesk && costiStrutturaDesk.length > 0 ? (
                            ...
                            <TableRow key={costo.id}>
                              <TableCell>
                                {editingCostoStrutturaDesk?.id === costo.id ? (
                                    <Input
                                        ...
                                        onChange={(e) => setEditingCostoStrutturaDesk({
                                          ...editingCostoStrutturaDesk,
                                          layout_desk: e.target.value
                                        })}
                                        className="w-24"
                                    />
                                ) : (
                              ...
                              <TableCell>
                                {editingCostoStrutturaDesk?.id === costo.id ? (
                                    <div className="flex items-center gap-1">
                                      <Button size="sm"
                                              onClick={() => updateCostoStrutturaDeskMutation.mutate(editingCostoStrutturaDesk)}
                                              disabled={updateCostoStrutturaDeskMutation.isPending}>
                                        <Save className="h-4 w-4"/>
                                      </Button>
                                      <Button size="sm" variant="outline"
                                              onClick={() => setEditingCostoStrutturaDesk(null)}>
                                        <X className="h-4 w-4"/>
                                      </Button>
                                    </div>
                                ) : (
                                    <div className="flex items-center gap-1">
                                      <Button size="sm" variant="outline"
                                              onClick={() => setEditingCostoStrutturaDesk(costo)}>
                                        <Edit className="h-4 w-4"/>
                                      </Button>
                                      <Button
                                          size="sm"
                        ...
                        <TableRow>
                          <TableCell colSpan={3} className="text-center">Nessun costo struttura desk
                            trovato</TableCell>
                        </TableRow>
                    )}
                  </TableBody>
              ...
              <CardHeader>
                <div className="flex flex-row items-center justify-between">
                  <div>
                    ...
                    <CardDescription>Costo struttura espositori in funzione del
                      layout</CardDescription>
                  </div>
                  <div className="w-[120px] flex justify-end">
              ...
              <CardContent>
                {showAddCostoStrutturaEspositori && (
                    <div className="mb-4 flex items-end gap-2">
                      ...
                      <Button size="sm" onClick={handleAddCostoStrutturaEspositoreSave}
                              disabled={addCostoStrutturaEspositoreMutation.isPending}>
                        <Save className="h-4 w-4"/>
                      </Button>
                      <Button size="sm" variant="outline"
                              onClick={handleAddCostoStrutturaEspositoreCancel}>
                        <X className="h-4 w-4"/>
                      </Button>
                    </div>
                )}
                <Table>
                  ...
                  <TableBody>
                    {costiStrutturaEspositori && costiStrutturaEspositori.length > 0 ? (
                            ...
                            <TableRow key={costo.id}>
                              <TableCell>
                                {editingCostoStrutturaEspositori?.id === costo.id ? (
                                    <Input
                                        ...
                                        onChange={(e) => setEditingCostoStrutturaEspositori({
                                          ...editingCostoStrutturaEspositori,
                                          layout_espositore: e.target.value
                                        })}
                                        className="w-24"
                                    />
                                ) : (
                              ...
                              <TableCell>
                                {editingCostoStrutturaEspositori?.id === costo.id ? (
                                    <div className="flex items-center gap-1">
                                      <Button size="sm"
                                              onClick={() => updateCostoStrutturaEspositoreMutation.mutate(editingCostoStrutturaEspositori)}
                                              disabled={updateCostoStrutturaEspositoreMutation.isPending}>
                                        <Save className="h-4 w-4"/>
                                      </Button>
                                      <Button size="sm" variant="outline"
                                              onClick={() => setEditingCostoStrutturaEspositori(null)}>
                                        <X className="h-4 w-4"/>
                                      </Button>
                                    </div>
                                ) : (
                                    <div className="flex items-center gap-1">
                                      <Button size="sm" variant="outline"
                                              onClick={() => setEditingCostoStrutturaEspositori(costo)}>
                                        <Edit className="h-4 w-4"/>
                                      </Button>
                                      <Button
                                          size="sm"
                        ...
                        <TableRow>
                          <TableCell colSpan={3} className="text-center">Nessun costo struttura
                            espositori trovato</TableCell>
                        </TableRow>
                    )}
                  </TableBody>
