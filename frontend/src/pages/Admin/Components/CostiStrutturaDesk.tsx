...
import { CostiStrutturaDeskBean } from '@/types/parametri';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
/* =====================================================
   CostiStrutturaDesk
===================================================== */
export function CostiStrutturaDesk() {
  ...
  const [editingCosto, setEditingCosto] =
      useState<CostiStrutturaDeskBean | null>(null);
  ...
  /* =========================
     QUERY
  ========================= */
  const { data: costi = [] } = useQuery<CostiStrutturaDeskBean[]>({
    queryKey: ['costi-struttura-desk'],
    queryFn: () =>
        ParametriAPI.getCostiStrutturaDesk({
          attivo: true,
        }),
  });
  ...
  const saveMutation = useMutation<
      ...
      CostiStrutturaDeskBean
  >({
    mutationFn: ParametriAPI.saveCostiStrutturaDesk,
    onSuccess: () => {
      ...
      toast({
        ...
        description: 'Costo struttura desk aggiornato correttamente.',
      });
    },
  });
  ...
  >({
    ...
    onSuccess: () => {
      ...
      toast({
        ...
        description: 'Costo struttura desk aggiunto correttamente.',
      });
    },
  });

  const deleteMutation = useMutation<void, unknown, string>({
    mutationFn: ParametriAPI.deleteCostiStrutturaDesk,
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: ['costi-struttura-desk'],
      });
      toast({
        ...
        description: 'Costo struttura desk disattivato.',
      });
    },
  });
  ...
  /* =========================
     HANDLERS
  ========================= */
  const handleEdit = (c: CostiStrutturaDeskBean) => {
    setEditingCosto(c);
    setEditLayout(c.layoutDesk);
  ...
  const handleAddSave = () => {
    ...
    addMutation.mutate({
      layoutDesk: newLayout.trim(),
      costoUnitario: costo,
      attivo: true,
    } as CostiStrutturaDeskBean);
  };
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Costo struttura desk in funzione del layout
              </CardDescription>
            </div>
