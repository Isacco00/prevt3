...
import {ParametriACostiUnitariBean, ParametriBean} from "@/types/parametri.ts";
...
export default function Admin() {
    ...
    const [editingParameter, setEditingParameter] = useState<ParametriBean | ParametriACostiUnitariBean | null>(null);
    const [editValue, setEditValue] = useState<ParametriBean['valore'] | ParametriACostiUnitariBean['valore'] | null>(null);
