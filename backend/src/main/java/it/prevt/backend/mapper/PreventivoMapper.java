...
public class PreventivoMapper extends AbstractMapper<Preventivo, PreventivoBean> {
  ...
  protected PreventivoBean doMapping(PreventivoBean bean, Preventivo entity) {
    ...
    bean.setAccessoriDeskConfig(entity.getAccessoriDeskConfig());

    bean.setBorsaEspositori(entity.getBorsaEspositori());
    bean.setPremontaggio(entity.getPremontaggio());
    bean.setPremontaggioStorage(entity.getPremontaggioStorage());
    ...
    bean.setScontoStrutturaStorage(entity.getScontoStrutturaStorage());
    bean.setScontoGraficaStorage(entity.getScontoGraficaStorage());
    bean.setScontoPremontaggioStorage(entity.getScontoPremontaggioStorage());
    bean.setGraficaStorageAttiva(entity.getGraficaStorageAttiva());
    bean.setScontoStrutturaGlobale(entity.getScontoStrutturaGlobale());
    bean.setScontoGraficaGlobale(entity.getScontoGraficaGlobale());
    bean.setScontoRetroilluminazioneGlobale(entity.getScontoRetroilluminazioneGlobale());
    bean.setScontoAccessoriGlobale(entity.getScontoAccessoriGlobale());
    bean.setScontoPremontaggiGlobale(entity.getScontoPremontaggiGlobale());
    bean.setScontoServiziGlobale(entity.getScontoServiziGlobale());
    bean.setScontoAltriBeniGlobale(entity.getScontoAltriBeniGlobale());
    ...
    bean.setScontoStrutturaDesk(entity.getScontoStrutturaDesk());
    bean.setScontoGraficaDesk(entity.getScontoGraficaDesk());
    bean.setScontoPremontaggioDesk(entity.getScontoPremontaggioDesk());
    bean.setScontoAccessoriDesk(entity.getScontoAccessoriDesk());
    ...
    bean.setScontoStrutturaEspositori(entity.getScontoStrutturaEspositori());
    bean.setScontoGraficaEspositori(entity.getScontoGraficaEspositori());
    bean.setScontoPremontaggioEspositori(entity.getScontoPremontaggioEspositori());
    bean.setScontoAccessoriEspositori(entity.getScontoAccessoriEspositori());
