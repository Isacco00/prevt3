-- Rename lunghezza column to profondita
ALTER TABLE public.preventivi RENAME COLUMN lunghezza TO profondita;

-- Increase precision for numeric columns to prevent overflow (2 decimal places)
ALTER TABLE public.preventivi 
  ALTER COLUMN costo_mq TYPE NUMERIC(15,2),
  ALTER COLUMN costo_mc TYPE NUMERIC(15,2),
